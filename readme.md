...
1) В режиме наблюдения через COM нужно сначала сформировать массив от 0 до 4095, а потом записывать в него. получаемая X значение это номер в массиве в который нужно записать Y


**Доделать**
Сделать таблицу в которую будут выводится списком все элементы по возврастанию длины волны и поиск по элементу или длине волны
