...
**Доделать**
Сделать таблицу в которую будут выводится списком все элементы по возврастанию длины волны и поиск по элементу или длине волны. Либо сделать поиск ждешь на энергию она пересчитывается в длину волны и алгоритм выводит все элемнты радом с этой длиной волны в n (от 1 до 3) порядке
